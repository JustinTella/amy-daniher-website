  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        {reviews.map((r, i) => (
          <div key={i} className="border border-gray-200 rounded p-6 flex flex-col min-h-[220px]">
...
function AboutUsPage() {
  const teamMembers = [
    { name: 'Amy Daniher', title: 'M.D.', image: drPortrait },
  ...
  return (
    <>
      ...
      <main className="bg-light-gray">
        ...
        <section id="testimonials" className="pb-16 scroll-mt-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <GoogleReviewWidget />
          </div>
        </section>
