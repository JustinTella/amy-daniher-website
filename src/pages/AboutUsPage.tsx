...
function AboutUsPage() {
  ...
  const teamMembers = [
    { name: 'Amy Sawyer Daniher', title: 'M.D.', image: drPortrait },
    { name: 'Shawna Guzman', title: 'Office Manager', image: shawnaImage },
    { name: 'Michelle Martinez', title: 'Medical Assistant', image: kimPortrait },
  ];

  const testimonials: Testimonial[] = [
    { quote: 'Dr. Daniher has served our family with candor, realistic individualized guidance with a comprehensive focus on our long-term health for over a decade. Her staff is professional and congenial.', name: 'Susan W.', profession: 'Corporate Attorney', yearJoined: '2011', rangeId: 'professionals' },
    ...
    { quote: 'I was pleased to update my medications with Dr. Daniher. It is a reassuring feeling when your blood work does not show anything shocking. Dr. Daniher is on top of my health issues.', name: 'Kathleen N.', profession: 'Retired Hospital Administrator', yearJoined: '2018', rangeId: 'retirees' },
    { quote: 'Dr. Daniher is the best of the best. She really listens, she is realistic while also being positive, and she really cares. She does not rush through your appointment and makes you feel seen and heard, which is rare in the medical field.', name: 'Michaela B.', profession: 'UX Design Director', yearJoined: '2020', rangeId: 'professionals' },
    { quote: 'Dr. Daniher is an excellent physician and a beautiful human being. She has been my physician for over 20 years. I moved from San Mateo to San Jose, but I continue to travel to San Mateo to have her as my wife\'s and my physician.', name: 'Jose (Joe) A.', profession: 'Semiconductor Engineer', yearJoined: '2004', rangeId: 'families' },
    ...
    { quote: 'Dr. Daniher is very thorough and conscientious. She called me to say we had not met in a while and wanted to do a checkup, even though I was not due for a complete physical until after the first of the year.', name: 'Linda Z.', profession: 'Biotech Executive', yearJoined: '2013', rangeId: 'executives' },
    { quote: 'My first visit was better than I expected. My previous doctor was awesome, and Dr. Daniher upped the game.', name: 'Philip G.', profession: 'Product Strategy Consultant', yearJoined: '2022', rangeId: 'executives' },
    { quote: 'My visit was very professional. Everything worked according to schedule. I feel very comfortable with Dr. Daniher. She answers all my questions and I leave the office very satisfied and feeling extremely healthy.', name: 'Margaret R.', profession: 'Retired Nurse', yearJoined: '2015', rangeId: 'retirees' },
    ...
    { quote: 'Dr. Daniher is a true professional. She is kind, compassionate, and listens without judgment. She works diligently to serve her clients\' needs. Moving to concierge care with Dr. Daniher was by far the best decision I made for my family.', name: 'Edwina T.', profession: 'Chief People Officer', yearJoined: '2021', rangeId: 'families' },
    ...
    { quote: 'I usually have a pleasant visit with Dr. Daniher. I have been her patient for about 12 years now. She is a caring person and does the best for her patients.', name: 'Donna R.', profession: 'Retired CPA', yearJoined: '2012', rangeId: 'retirees' },
    { quote: 'Dr. Daniher has been precisely aware of the needs of my husband and me while treating an unknown virus. It was first-rate care and truly appreciated.', name: 'Jane J.', profession: 'Private Wealth Manager', yearJoined: '2016', rangeId: 'families' },
    { quote: 'Dr. Daniher is great. Very engaged during our appointments and knowledgeable about all my healthcare maintenance issues. Highly recommend Dr. Daniher for personalized healthcare.', name: 'Vicky H.', profession: 'Program Manager', yearJoined: '2020', rangeId: 'professionals' },
    { quote: 'Dr. Daniher takes the time to listen to patients and give proper advice. She is very kind.', name: 'Dale B.', profession: 'Retired Venture Capital Partner', yearJoined: '2017', rangeId: 'active' },
    ...
    { quote: 'The office staff are sweet and friendly, and Dr. Daniher is the best.', name: 'Lily C.', profession: 'Independent College Consultant', yearJoined: '2022', rangeId: 'families' },
  ];
        ...
        <section id="testimonials" className="pb-12 scroll-mt-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <a href="https://www.google.com/maps/search/?api=1&query=Amy%20Sawyer%20Daniher%2C%20M.D.%2C%2034%20N%20San%20Mateo%20Drive%20%231%2C%20San%20Mateo%2C%20CA%2094401" target="_blank" rel="noopener noreferrer" className="mt-6 inline-flex items-center justify-center px-6 py-2.5 bg-navy text-white font-medium hover:bg-steely-blue transition-colors duration-200 w-full text-sm uppercase tracking-wide active:scale-[0.98]">View Google Reviews</a>
                </div>
                <div className="flex flex-col items-center text-center p-6 bg-white border border-gray-300">
              ...
              <a href="https://www.yelp.com/search?find_desc=Amy%20Sawyer%20Daniher%2C%20M.D.&find_loc=San%20Mateo%2C%20CA" target="_blank" rel="noopener noreferrer" className="mt-6 inline-flex items-center justify-center px-6 py-2.5 bg-navy text-white font-medium hover:bg-steely-blue transition-colors duration-200 w-full text-sm uppercase tracking-wide active:scale-[0.98]">View Yelp Reviews</a>
                </div>
              </div>
            </motion.div>
          </div>
