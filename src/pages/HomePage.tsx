          ...
          <div className="relative z-10 mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="mt-5 px-1 md:px-2">
                ...
                <h1 className="mb-2 whitespace-nowrap text-[2.2rem] font-semibold leading-[0.95] tracking-[-0.03em] text-white drop-shadow-[0_3px_18px_rgba(15,23,42,0.45)] md:text-[3.4rem] lg:text-[4.6rem]">
