...
function MembershipPage() {
  ...
  const slides = [
    ...
    },
    {
      ...
      content:
        'Dr. Daniher makes herself available to her patients with 24/7 communication by email or her personal cell phone. Now her office visits are longer, she is more available, and she is better able to communicate on your behalf with the other physicians involved in your care.',
    },
    {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        'Please call our office and ask for the Patient Membership Agreement. Then complete and sign the Agreement and send it on to our office at 34 N. San Mateo Drive, Suite #1, San Mateo, CA94401.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Yes, Dr. Daniher is a Participating Provider with Medicare and will bill Medicare on your behalf, as required by law.',
    },
    {
      question: 'Do you bill Medicare for the annual concierge fee?',
      answer:
        'The annual concierge fee only includes services that are not covered by Medicare and, as such, cannot be paid for or reimbursed by Medicare. Dr. Daniher will bill Medicare for your sick visits and for any additional services performed at her practice that are covered by Medicare.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Dr. Daniher is available to help you decide what specialists to see and to coordinate such consultations. In this way the most appropriate resource is used, the earliest arrangements are made, and your applicable medical information is sent in advance of your specialist visit.',
    },
    {
      question: 'What if I need to be hospitalized?',
      answer:
        'Dr. Daniher has privileges at Mills-Peninsula Hospital. If you are hospitalized there, Dr. Daniher will visit you, be your advocate in treatment decisions, and help better coordinate care with the hospital physicians. The hospital physicians will continue to be the primary physicians on site to handle your hospitalization.',
    },
    {
      question: "Will I still benefit from this Membership Program if I don't need frequent medical attention?",
      answer:
        'Yes. Our practice focuses on wellness and disease prevention, which are important factors throughout your life. In addition, the small practice size will assure that calls will be answered quickly, you will be seen when you want to be seen, and you will have more time during your office visits. Moreover, as you can easily reach Dr. Daniher directly via phone or email, you may often get your questions answered easily and without the need for coming into the office. Oftentimes, even trips to the emergency department can be prevented by getting in touch with Dr. Daniher in an easy and timely fashion.',
    },
    {
      question: 'How do I get in touch with Dr. Daniher?',
      answer:
        'Once you join our Membership Practice, you will be given Dr. Daniher\'s email and personal cell phone number. Our office is open from 8:30 am to 5:00 pm. During office hours we ask that you call the office first. Our staff will relay the message to Dr. Daniher and she will personally return your call. After hours, Dr. Daniher answers calls or returns calls promptly. You can also email with non-urgent questions any time and Dr. Daniher will respond within one day.',
    },
    {
      question: 'What happens when Dr. Daniher is on vacation?',
      answer:
        'On the infrequent occasions when Dr. Daniher is out of town or otherwise unavailable, she will have another quality physician cover for her. Even while out of town, she will often be available by phone to you and to covering physicians.',
    },
    {
