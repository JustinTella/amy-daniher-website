          ...
          <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="bg-white p-8 md:p-10 shadow-sm border border-gray-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="flex flex-col items-center text-center p-6 bg-white border border-gray-300">
                ...
                <a href="https://www.google.com/maps/search/?api=1&query=Amy%20Sawyer%20Daniher%2C%20M.D.%2C%2034%20N%20San%20Mateo%20Drive%20%231%2C%20San%20Mateo%2C%20CA%2094401" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-6 py-2.5 bg-navy text-white font-medium hover:bg-steely-blue transition-colors duration-200 w-full text-sm uppercase tracking-wide">Review us on Google</a>
              </div>
              <div className="flex flex-col items-center text-center p-6 bg-white border border-gray-300">
                ...
                <a href="https://www.yelp.com/search?find_desc=Amy%20Sawyer%20Daniher%2C%20M.D.&find_loc=San%20Mateo%2C%20CA" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-6 py-2.5 border border-navy text-navy font-medium hover:bg-navy hover:text-white transition-colors duration-200 w-full text-sm uppercase tracking-wide">View Yelp Reviews</a>
              </div>
            </div>
