  ...
  return (
    ...
    >
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="mb-3 w-[340px] origin-bottom-right overflow-hidden rounded-[24px] border border-steely-blue/30 bg-white shadow-[0_18px_40px_rgba(95,118,128,0.16)]"
          >
            <div className="border-b border-steely-blue/25 bg-light-gray px-4 py-3.5">
              <div>
            ...
            <div className="bg-light-gray px-4 py-4">
              <div className="space-y-3 rounded-[22px] bg-white px-3 py-3 shadow-[inset_0_0_0_1px_rgba(143,201,197,0.35)]">
                <div className="flex justify-start">
                  <div className="max-w-[82%] rounded-[18px] rounded-bl-[6px] bg-steely-blue/18 px-3 py-2 text-[13px] leading-5 text-navy/78">
              ...
              <div className="mt-4 flex items-end gap-2 rounded-[22px] border border-steely-blue/30 bg-white p-2">
                <textarea
                  value={message}
      ...
      <button
        ...
        className="inline-flex items-center gap-2 rounded-full border-2 border-steely-blue/45 bg-white px-4 py-2.5 text-[14px] font-semibold text-navy shadow-[0_14px_28px_rgba(95,118,128,0.14)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-light-gray"
