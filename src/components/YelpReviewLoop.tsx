...
const YELP_REVIEWS: YelpReview[] = [
  {
    ...
    rating: 5,
    text:
      'I think Dr. Daniher is the greatest doctor. She is smart, kind, and caring, and my family has trusted her care for years.',
  },
  {
    author: 'Andrea M.',
    rating: 5,
    text:
      'Dr. Daniher is the best doctor I have ever been to. She takes the time to listen to your concerns and never makes you feel rushed.',
  },
  {
    author: 'Brendan F.',
    rating: 5,
    text:
      'I have been seeing Dr. Daniher for years and would not imagine seeing any other doctor. She takes the time to explain conditions clearly and thoughtfully.',
  },
  {
    author: 'Patricia P.',
    rating: 5,
